...
//    NSLog(@"----------------%@",[Manager redingwenjianming:@"companyID.text"]);
...
- (NSMutableArray *)qxArray {
    if (_qxArray == nil) {
        self.qxArray = [NSMutableArray arrayWithCapacity:1];
    }
    return _qxArray;
}
- (NSMutableArray *)qxArrayEr {
    if (_qxArrayEr == nil) {
        self.qxArrayEr = [NSMutableArray arrayWithCapacity:1];
    }
    return _qxArrayEr;
}
- (NSMutableArray *)qxArraySan {
    if (_qxArraySan == nil) {
        self.qxArraySan = [NSMutableArray arrayWithCapacity:1];
    }
    return _qxArraySan;
}

- (NSMutableArray *)roleQXArray{
    if (_roleQXArray == nil) {
        self.roleQXArray = [NSMutableArray arrayWithCapacity:1];
    }
    return _roleQXArray;
}
- (NSMutableArray *)roleQXArrayEr{
    if (_roleQXArrayEr == nil) {
        self.roleQXArrayEr = [NSMutableArray arrayWithCapacity:1];
    }
    return _roleQXArrayEr;
}
- (NSMutableArray *)roleQXArraySan{
    if (_roleQXArraySan == nil) {
        self.roleQXArraySan = [NSMutableArray arrayWithCapacity:1];
    }
    return _roleQXArraySan;
}
...
- (NSMutableArray *)companyArray {
    if (_companyArray == nil) {
        self.companyArray = [NSMutableArray arrayWithCapacity:1];
    }
