...
+ (void)showUpdateAlertWithVersion:(NSString *)version Descriptions:(NSArray *)descriptions
{
    ...
    [[UIApplication sharedApplication].delegate.window bringSubviewToFront:updateAlert];
}
...
- (void)updateVersion
{
    NSString *str = @"itms-apps://itunes.apple.com/cn/app/jie-zou-da-shi/id1309457456?mt=8";
